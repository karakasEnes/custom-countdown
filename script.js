...
let savedCountdown; //local Storage;
...
function updateDOM() {
  countdownActive = setInterval(() => {
    ...
    //if the countdown is ended show complete
    ...
    if (distance < 0) {
      ...
      // show countdown in progress and hide complete countdown container
      //populate countdown
...
function reset() {
  ...
  // stop the countdown
  clearInterval(countdownActive);
  //clearing our countdowntitle and date also localStorage
  countdownTitle = "";
  countdownDate = "";
